...
class keyfob_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Keyfob Rx")
        ...
        self.limesdr_source_0 = limesdr.source('xxxxxxxxxxxxxxxxx', 0, '', False)


        self.limesdr_source_0.set_sample_rate(1e6)


        self.limesdr_source_0.set_center_freq(433996000, 0)
        ...
        self.connect((self.limesdr_source_0, 0), (self.blocks_complex_to_mag_0, 0))
